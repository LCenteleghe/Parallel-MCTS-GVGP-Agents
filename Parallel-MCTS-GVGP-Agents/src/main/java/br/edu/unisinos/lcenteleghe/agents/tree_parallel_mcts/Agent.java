package br.edu.unisinos.lcenteleghe.agents.tree_parallel_mcts;
...
public class Agent extends AbstractPlayer {
	...
	public Agent(StateObservation so, ElapsedCpuTimer elapsedTimer) {
		this.mctsAlgorithm = ParallelizableUctMctsAlgorithm.<GameState, Types.ACTIONS>builder()
				...
				.setParallelismLevelFor(ParallelizationTechnique.TREE,
						Integer.valueOf(GlobalNumThreadsParamForAgent.numThreads))
				.build();
	}
